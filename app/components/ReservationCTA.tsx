            ...
            {bookingDetails.map((detail) => (
              <div key={detail.label} className="grid min-h-[58px] grid-cols-[30px_minmax(0,1fr)] items-center gap-3 border border-[#D4A373]/18 bg-[#FFF7ED]/6 p-2.5 shadow-[0_18px_48px_rgba(0,0,0,0.22)] backdrop-blur sm:min-h-[88px] sm:grid-cols-[40px_minmax(0,1fr)] sm:gap-4 sm:p-4">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center bg-[#fd850b]/18 text-[#fd850b] sm:h-10 sm:w-10">
                  <i className={`fa-solid ${detail.icon} text-xs sm:text-base`} aria-hidden="true" />
                </span>
        ...
        <div className="relative hidden border border-[#D4A373]/22 bg-[#FFF7ED]/6 p-3 shadow-[0_32px_90px_rgba(0,0,0,0.48)] backdrop-blur sm:block">
          <div className="relative aspect-[16/11] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
              <p className="text-xs font-black uppercase text-[#fd850b]">Tonight at Bravo</p>
              <p className="mt-2 max-w-sm font-serif text-3xl uppercase leading-none text-[#FFF7ED] sm:text-4xl">Hot skewers, cold drinks, full tables</p>
            </div>
          </div>

          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <div className="bg-[#120807]/72 p-4 ring-1 ring-[#D4A373]/18">
              <p className="text-xs font-black uppercase text-[#fd850b]">Best for</p>
              <p className="mt-1 text-sm leading-6 text-[#f4d8c5]">Birthdays, date nights, team dinners</p>
            </div>
            <div className="bg-[#120807]/72 p-4 ring-1 ring-[#D4A373]/18">
              <p className="text-xs font-black uppercase text-[#fd850b]">Location</p>
              <p className="mt-1 text-sm leading-6 text-[#f4d8c5]">Phnom Penh, Cambodia</p>
            </div>
          </div>
        </div>
      </motion.div>
